layui.use(['element', 'jquery', 'layer', 'laytpl', 'laypage', 'form', 'table'], function() {
	...
	table.render({
		elem: '#'
		,url:'/user_center/orders1'
		,cols: [[
			{field:'orderId', title:'编号', width:120, fixed: 'left',unresize: true,  sort: true}
			,{field:'consigneeName', title:'报修人', width:120}
			,{field:'address', title:'地址', width:200}
			,{field:'zip', title:'事由', width:100, sort: true}
